...
import { ClipboardList, RefreshCw, Clock, AlertTriangle } from "lucide-react";
...
export const StandupReport: React.FC<StandupReportProps> = ({
  allActivities,
  loading: dataLoading,
}) => {
  const {
    ...
    error,
    regenerate,
  } = useAIReport("standup", allActivities, !dataLoading);
